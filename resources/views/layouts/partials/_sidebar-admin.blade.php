<aside class="sticky top-0 flex h-screen w-64 shrink-0 flex-col border-r border-line bg-surface/40">
    ...
    <nav class="flex-1 space-y-1 px-4 py-2">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 rounded-md px-3 py-2.5 text-[15px] transition-colors {{ request()->routeIs('admin.dashboard') ? 'bg-accent-tint font-medium text-accent-bright' : 'text-muted hover:bg-white/5 hover:text-ink' }}">
    ...
    <div class="border-t border-line p-4">
        <div class="flex items-center gap-3 rounded-md px-2 py-2">
            ...
            <div class="min-w-0">
                ...
                <p class="truncate text-xs text-muted">Admin</p>
            </div>
        </div>
